...
const HomePage = () => {
	const HomePageDetails = {
		donate_blood: {
			...
			headingText: "Donate Blood with MBlood",
			classHint: "side-col-image donate-blood-with-MBlood",
			paraText:
		...
		eligiblity_criteria: {
			...
			imageUrl: "../../../assets/images/bd6.jpg",
			buttonText: "Donate Now",
			buttonLink: "/donate-blood",
			buttonHave: false,
		},
		hero: {
            ...
            headingText: "Join The Fight Donate Blood",
            classHint: "home-page-hero",
        },
		stepsText: {
            subheadingText: "How It Works",
            headingText: "Easy Steps to Become a Donor",
        },
	};
