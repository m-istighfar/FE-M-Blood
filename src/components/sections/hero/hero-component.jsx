...
const HeroComponent = ({ subheadingText, headingText, buttonText, buttonLink, classHint }) => {
    return (
        <section className={`main-wrapper ${classHint}`}>
            <div className="hero-container home-page-hero-animated flex justify-center items-center">
                <div className="text-container md:w-[700px] flex flex-col justify-center items-center p-5">
                    ...
                    {buttonText && (
                        <a href={buttonLink} className="mt-4 bg-primary hover:bg-primary-dark text-white py-2 px-6 rounded shadow-lg transition duration-300">
                            {buttonText}
                        </a>
                    )}
                </div>
