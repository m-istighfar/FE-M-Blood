    ...
    <footer className="footer bg-off_white text-dark pt-12 pb-8 px-4">
      <div className="container mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="footer-explore">
          <h3 className="text-lg font-semibold uppercase mb-4">Explore</h3>
          <ul>
        ...
        <div className="footer-contact">
          <h3 className="text-lg font-semibold uppercase mb-4">Contact</h3>
          <ul>
      ...
      <div className="footer-bottom text-center border-t border-gray mt-8 pt-6">
        <p>
          ...
          <a
            href="linkedin.com/in/restu-windri-pangestu-590849257"
