    ...
    return (
        <NavLink
            ...
            className={`cta-btn mt-5 mx-auto rounded-rsm border
                ${
                    buttonType === "solid"
                        ? "bg-blue text-red hover:bg-blue-600 hover:text-blue-800" 
                        : "bg-transparent text-gray-300 border border-gray-300 hover:border-blue-600 hover:bg-blue-600 hover:text-gray-100"
                }
                transition duration-300 ease-in-out
                text-lg px-4 py-2 font-semibold inline-block text-center`} // Mengubah dari block ke inline-block dan mengatur px
        >
            {buttonText}
        </NavLink>
    );
